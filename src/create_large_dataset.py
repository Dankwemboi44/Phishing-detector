...
data = [
    ...
    ['Umeteuliwa kushinda 100,000 KES. Thibitisha sasa', 'phishing'],
    ['M-PESA: Account yako imesimamishwa. Bofya link', 'phishing'],
    ['Kampuni yetu inakupa reward. Tumia link hii', 'phishing'],
    ['Security alert! Login required immediately', 'phishing'],
    
    # Safe examples (12 messages)
    ...
    ['Message ya kawaida tu, nothing special', 'safe']
]
